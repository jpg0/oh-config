...
with(fluent.withToggle) {
    when(item('Garage_Side_Door_Occupancy').changed().to('OPEN')).
    ...
    when(item('Garage_Car_Door_Contact').changed().to('OPEN')).
        or(item('Garage_Side_Door_Occupancy').changed().to('OPEN')).
