...
class XiaomiZigbeeEndDeviceTAI extends zigbeetai.ZigbeeTAI {
    ...
    buildObjects(){
        ...
        this.lastUpdatedItem = items.createItem(`${this.id}_LastUpdated`, 'DateTime', 'clock', ['gLastUpdated'], `${this.id} Last Seen [JS(since.js):%s]`);
    ...
    this.items.push(this.lastUpdatedItem);
        ...
        let batteryItem = items.createItem(`${this.id}_Battery`, 'Number', 'batterylevel', ['gBattery', `g${this.id}_Measurements`], `${this.id} Battery [%.1f%%]`, ["Battery"]);
...
class AqaraButtonTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Button`, 'String', null, this.groups, `${this.id} Button`, ["RemoteControl"]),
...
class AqaraMotionTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Illuminance`, 'Number', 'light', ['gIlluminance',`g${this.id}_Measurements`], `${this.id} Illuminance [%.1f]`, ["Sensor"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Occupancy`, 'Contact', 'occupancy', [...this.groups, 'gOccupancy',`g${this.id}_Measurements`], `${this.id} Occupancy`, ["MotionDetector"]),
...
class AqaraContactTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Contact`, 'Contact', 'door', [...this.groups, 'gContact',`g${this.id}_Measurements`], `${this.id} Contact`, ["Sensor"]),
...
class MijiaTemperatureTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Temperature`, 'Number', 'temperature', [...this.groups, 'gTemperature',`g${this.id}_Measurements`], `${this.name} Temperature [%.1f °C]`, ["Sensor"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Humidity`, 'Number', 'water', ['gHumidity',`g${this.id}_Measurements`], `${this.id} Humidity [%.1f]`, ["Sensor"]),
...
class AqaraTemperatureTAI extends MijiaTemperatureTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Pressure`, 'Number', 'pressure', ['gPressure',`g${this.id}_Measurements`], `${this.id} Pressure [%.1f]`, ["Sensor"]),
...
class AqaraSwitchTAI extends zigbeetai.ZigbeeTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Switch`, 'Switch', 'light', this.groups, `${this.id} Switch`, ["PowerOutlet"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Switch_Power`, 'Number', 'energy', ['gHourlyStats'], `${this.id} Power`, ["Sensor"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_Switch_Temperature`, 'Number', 'temperature', ['gHourlyStats'], `${this.id} Switch Temperature`, ["Sensor"]),
            this.withNewMQTTChannel("temperature", "Number", "number", {
                stateTopic: `${this.mqttRoot}/${this.zigbeeId}`,
                transformationPattern: "JSONPATH:$.temperature"
            }));
