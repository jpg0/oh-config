...
class AqaraButtonTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Button`, 'String', null, this.groups, `${this.id} Button`, ["Switch"]),
...
class AqaraContactTAI extends XiaomiZigbeeEndDeviceTAI {
    init(config) {
        ...
        this.contactGroup = config.contactGroup;
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Contact`, 'Contact', 'door', [this.equipmentItem.name, 'gContact',this.measurementGroupItem.name, this.contactGroup], `${this.id} Contact`, ["Opening", "OpenState"]),
...
class MijiaTemperatureTAI extends XiaomiZigbeeEndDeviceTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Temperature`, 'Number', 'temperature', [this.equipmentItem.name, 'gTemperature', this.measurementGroupItem.name, this.temperatureGroup], `${this.name} Temperature [%.1f °C]`, ["Measurement", "Temperature"]),
...
class AqaraSwitchTAI extends zigbeetai.ZigbeeTAI {
    ...
    buildObjects(){
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Switch`, 'Switch', 'light', this.groups, `${this.id} Switch`, ["Switch"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Switch_Power`, 'Number', 'energy', ['gHourlyStats'], `${this.id} Power`, ["Measurement", "Power"]),
        ...
        this.linkItemToChannel(
            items.createItem(`${this.id}_${this.equipmentTypeLabel}_Switch_Temperature`, 'Number', 'temperature', ['gHourlyStats'], `${this.id} Switch Temperature`, ["Measurement", "Temperature"]),
            this.withNewMQTTChannel("temperature", "Number", "number", {
                stateTopic: `${this.mqttRoot}/${this.zigbeeId}`,
                transformationPattern: "JSONPATH:$.temperature"
            }));
