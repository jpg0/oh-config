...
class ZigbeeColorBulbTAI extends zigbeetai.ZigbeeTAI {
    ...
    buildObjects() {
        ...
        let realItem = items.createItem(`${this.itemPrefix}${this.id}_Light_Color_Real`, 'Color', 'light', [], `${this.name} Light (Real)`);
        this.linkItemToChannel(realItem, colorChannel);

        let proxyItem = items.createItem(`${this.itemPrefix}${this.id}_Light_Color`, 'Color', 'light', groups, `${this.name} Light`, [...this.tags, "Lightbulb", "ColorLight"]);
