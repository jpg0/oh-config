...
module.exports = [
    new TasmotaTAI({name: 'Xmas Tree', mqttId: 'sonoff-6E29EB', groups:['gUpstairs'], tags: ["LightStripe"]}),
    new TasmotaTAI({name: 'GarageCarDoor', mqttId: 'sonoff-095C5F', groups:['gGarage'], tags: ["GarageDoor"]}),
    ...
    new TasmotaTAI({name: 'Flamingo', mqttId: 'sonoff-3B47B7', tags: ["LightStripe"]}),
    ...
    new TasmotaTAI({name: 'UpstairsDoorLatch', mqttId: 'sonoff-56D77C', groups:["gUpstairs"], tags: ["InnerDoor"]}),

    new TasmotaTAI({name: 'BedPump', mqttId: 'tasmota_440B88', groups:["gUpstairs"], tags: ["Pump"]}),

    new HallwayLightsTAI(),
    
    new FourChannelTasmotaTAI({name: "ACDucts", mqttId: "sonoff-CAA8AF", tags: ["HVAC"]}),
