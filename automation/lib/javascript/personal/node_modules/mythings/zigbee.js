...
module.exports = [
    ...
    new ZigbeeColorBulbTAI({name: 'Games Room TV', zigbeeId: '0xb0ce1814000f3d74', zigbeeGroupId: "GamesRoomLights", groups: ["gColorLights","gGamesRoom","gEveningLights"], use_rgb: true}),
    // new ZigbeeColorBulbTAI({name: 'Games Room TV Old', zigbeeId: '0x0017880108b1efa4', zigbeeGroupId: "GamesRoomLights", groups: ["gColorLights","gGamesRoom","gEveningLights"]}),
