...
class ZigbeeDualColorBulbGroupTAI extends ZigbeeDualColorBulbTAI {
    ...
    buildObjects() {
        this.groupItem = items.createItem(`gz${this.id}`, 'Group', 'light', ['gZigbeeGroups', ...this.groups], `${this.name} Light Group`, ["LightStripe"]);
...
module.exports = [
    ...
    new ZigbeeColorBulbGroupTAI({name: 'GamesRoomLights', groupId: 'GamesRoomLights', groups: ['gGamesRoomLights', 'gGamesRoom']}),
    new ZigbeeColorBulbTAI({name: 'Games Room TV', zigbeeId: '0x00158d0001dd7f3e', zigbeeGroupId: "GamesRoomLights", groups: ["gColorLights","gGamesRoomLights","gGamesRoom", "gEveningLights"]}),// , use_rgb: true
    // new ZigbeeColorBulbTAI({name: 'Games Room TV Old', zigbeeId: '0xb0ce1814000f3d74', zigbeeGroupId: "GamesRoomLights", groups: ["gColorLights","gGamesRoomLights","gEveningLights"]}),
    new ZigbeeColorBulbTAI({name: 'Games Room Corner', zigbeeId: '0x00158d0001dd7f00', zigbeeGroupId: "GamesRoomLights", groups: ["gColorLights","gGamesRoomLights","gGamesRoom","gEveningLights"]}),

    new ZigbeeColorBulbTAI({name: 'Indis Closet', zigbeeId: '0x0017880103cfc584', groups: ["gIndisRoom", "gIndisRoomLights"]}),
    new ZigbeeColorBulbTAI({name: 'Hallway', zigbeeId: '0x0017880104190686', groups: ["gColorLights", "gHallway"]}),

    new ZigbeeColorBulbTAI({name: 'Upstairs Toilet', zigbeeId: '0x0017880106bc3445', groups: ["gColorLights","gUpstairsToilet"], tags:['NightDim']}),
    new ZigbeeColorBulbTAI({name: 'Upstairs Closet', zigbeeId: '0x0017880104985398', groups: ["gColorLights","gUpstairsCloset"]}),

    new ZigbeeColorBulbTAI({name: 'Bedside 1', zigbeeId: '0x0017880104184075', groups: ["gColorLights", "gUpstairsBedroom"]}),
    new ZigbeeColorBulbTAI({name: 'Bedside 2', zigbeeId: '0x00158d0002009074', groups: ["gColorLights", "gUpstairsBedroom"]}),

    new ZigbeeDualColorBulbGroupTAI({name: "KitchenLeds", groupId: "KitchenLeds", groups: ["gLivingRoom"]}),
    ...
    new ZigbeeButtonTAI({name: 'Bedside 2', zigbeeId: '0x04cf8cdf3c75c279', groups: ["gUpstairsBedroom"]}),

    new HueDimmerTAI({name: "Bedside 1", zigbeeId: '0x0017880104f1435e', groups: ["gUpstairsBedroom"]}),
];